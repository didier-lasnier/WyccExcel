...
/**
 * Converts a Number to a String using <code>NumberFormat.format(...).
...
public class NumberToStringConverter extends Converter {
	...
	/**
	 * Converts the provided <code>fromObject to a String.
	 * If the converter was constructed for an object type, non primitive, a
	 * <code>fromObject of null will be converted to an
	 * empty string.
	 * 
	 * @param fromObject
	 *            value to convert. May be <code>null if the converter
	...
	/**
	 * @param primitive
	 *            <code>true if the type is a double
	...
	/**
	 * @param primitive
	 *            <code>true if the type is a long
	...
	/**
	 * @param primitive
	 *            <code>true if the type is a float
	...
	/**
	 * @param primitive
	 *            <code>true if the type is a int
