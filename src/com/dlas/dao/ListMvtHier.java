...
public class ListMvtHier {
	...
	@Column(name = "RANKMVT")
	private Long rankmvt;
	@Column(name = "RANKPARENT")
	private Long rankparent;
	@Column(name = "NEXTMVT")
	private Long nextmvt;
	...
	private Long totalamountinsured1;
	...
	private Long totalamountinsured2;
	...
	private Long totalamountinsured3;
	...
	private Long totalamountinsured4;
	...
	private Long totalamountinsured5;
	...
	private Long totalamountinsured6;
	...
	private Long totalamountinsured7;
	...
	private Long totalamountinsured8;
	...
	public Long getRankmvt() {
		return rankmvt;
	}
	public Long getRankparent() {
		return rankparent;
	}
	public Long getNextmvt() {
		return nextmvt;
	}
	...
	public Long getTotalamountinsured1() {
	...
	public Long getTotalamountinsured2() {
	...
	public Long getTotalamountinsured3() {
	...
	public Long getTotalamountinsured4() {
	...
	public Long getTotalamountinsured5() {
	...
	public Long getTotalamountinsured6() {
	...
	public Long getTotalamountinsured7() {
	...
	public Long getTotalamountinsured8() {
	...
	public void setRankmvt(Long rankmvt) {
		this.rankmvt = rankmvt;
	}
	public void setRankparent(Long rankparent) {
		this.rankparent = rankparent;
	}
	public void setNextmvt(Long nextmvt) {
	...
	public void setTotalamountinsured1(Long totalamountinsured1) {
	...
	public void setTotalamountinsured2(Long totalamountinsured2) {
	...
	public void setTotalamountinsured3(Long totalamountinsured3) {
	...
	public void setTotalamountinsured4(Long totalamountinsured4) {
	...
	public void setTotalamountinsured5(Long totalamountinsured5) {
	...
	public void setTotalamountinsured6(Long totalamountinsured6) {
	...
	public void setTotalamountinsured7(Long totalamountinsured7) {
	...
	public void setTotalamountinsured8(Long totalamountinsured8) {
	...
	public ListMvtHier(Integer lv1, String positioncrew, String name, String firstname, String structurename,
			...
			String children, Long monthlysalary, String salarycurrency, Integer rang, Long niveau, String wyccid,
			Timestamp startmovement, Timestamp endmovement, Timestamp dateofnextmvt, Timestamp dateofprevmvt,
			Long rankmvt, Long rankparent, Long nextmvt, String company1, String formule1, String formulename1,
			String policenumber1, Long totalamountinsured1, String company2, String formule2, String formulename2,
			String policenumber2, Long totalamountinsured2, String company3, String formule3, String formulename3,
			String policenumber3, Long totalamountinsured3, String company4, String formule4, String formulename4,
			String policenumber4, Long totalamountinsured4, String company5, String formule5, String formulename5,
			String policenumber5, Long totalamountinsured5, String company6, String formule6, String formulename6,
			String policenumber6, Long totalamountinsured6, String company7, String formule7, String formulename7,
			String policenumber7, Long totalamountinsured7, String company8, String formule8, String formulename8,
			String policenumber8, Long totalamountinsured8) {
		super();
		this.lv1 = lv1;
		this.positioncrew = positioncrew;
		this.name = name;
