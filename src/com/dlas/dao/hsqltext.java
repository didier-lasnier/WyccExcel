...
public class hsqltext {
	...
	public String insertmvtnum ()
	{
		...
		sqlstmt = sqlstmt+" CIE_HT_BASIS5, COMPANY6,FORMULE_NAME6, FORMULA, POLICY_NUMBER6, CURRENCY6, EXCESS6, DURATION6, TOTAL_AMOUNT_INSURED6, CIE_HT_BASIS6, COMPANY7,FORMULE_NAME7, FORMULA7, POLICY_NUMBER7,";
	...
	public String insertbeneficiairies ()
	{
		...
		sqlstmt = sqlstmt+ " formule_name1, total_amount_insured1, formule_name2, total_amount_insured2, formule_name3, total_amount_insured3,";
		sqlstmt = sqlstmt+ " formule_name4, total_amount_insured4, formule_name5, total_amount_insured5, formule_name6, total_amount_insured6,";
	    sqlstmt = sqlstmt+ " formule_name7,total_amount_insured7,formule_name8,total_amount_insured8)";
	...
	public String insertRootListMvthier (){
		...
		sqlstmt = sqlstmt+" formule_name1, total_amount_insured1, formule_name2, total_amount_insured2, formule_name3, total_amount_insured3,";
		sqlstmt = sqlstmt+" formule_name4, total_amount_insured4, formule_name5, total_amount_insured5, formule_name6, total_amount_insured6,";
		sqlstmt = sqlstmt+" formule_name7,total_amount_insured7,formule_name8,total_amount_insured8, crewmanning, period_insurance, family_covered,";
	...
	public String insertLevelNListMvthier (){
		...
		sqlstmt = sqlstmt+" m.formule_name1, m.total_amount_insured1, m.formule_name2, m.total_amount_insured2, m.formule_name3, m.total_amount_insured3,";
		sqlstmt = sqlstmt+" m.formule_name4, m.total_amount_insured4, m.formule_name5, m.total_amount_insured5, m.formule_name6, m.total_amount_insured6,";
		sqlstmt = sqlstmt+" m.formule_name7, m.total_amount_insured7, m.formule_name8, m.total_amount_insured8,";
		sqlstmt = sqlstmt+"					 '' as crewmanning,  m.period_insurance,  m.family_covered,  m.nationality,  m.country,";
		sqlstmt = sqlstmt+"					  m.children,  m.monthly_salary,  m.salary_currency,   m.rankmvt as niveau,";
		sqlstmt = sqlstmt+"					  m.wycc_id,";
		sqlstmt = sqlstmt+"					 case when ( m.start_movement < timestamp '2016-01-01 00:00:00.0') then timestamp '2016-01-01 00:00:00.0' else  m.start_movement end as start_movement,";
