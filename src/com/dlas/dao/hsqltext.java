...
public class hsqltext {
	...
	public String insertmvtnum ()
	{
		...
		sqlstmt = sqlstmt+" CLAIMS_MANAGER_ID, GENDER, NAME, FIRST_NAME, DATE_OF_BIRTH, EMAIL, POSITION_TYPE, POSITIONCREW, MONTHLY_SALARY, SALARY_CURRENCY, PERIOD_INSURANCE, DAYS, MONTHS, ";
		sqlstmt = sqlstmt+" FAMILY_COVERED, RETIREMENT_PLAN, START_MOVEMENT, END_MOVEMENT, EMPLOYER, CHILDREN, COUNTRY, NATIONALITY, COMPANY1,FORMULE_NAME1, FORMULA1, POLICY_NUMBER1, CURRENCY1, ";
		sqlstmt = sqlstmt+" EXCESS1, DURATION1, TOTAL_AMOUNT_INSURED1, CIE_HT_BASIS1, COMPANY2,FORMULE_NAME2, FORMULA2, POLICY_NUMBER2, CURRENCY2, EXCESS2, DURATION2, TOTAL_AMOUNT_INSURED2,";
		sqlstmt = sqlstmt+" CIE_HT_BASIS2, COMPANY3,FORMULE_NAME3, FORMULA3, POLICY_NUMBER3, CURRENCY3, EXCESS3, DURATION3, TOTAL_AMOUNT_INSURED3, CIE_HT_BASIS3, COMPANY4,FORMULE_NAME4, FORMULA4, POLICY_NUMBER4,";
		sqlstmt = sqlstmt+" CURRENCY4, EXCESS4, DURATION4, TOTAL_AMOUNT_INSURED4, CIE_HT_BASIS4, COMPANY5,FORMULE_NAME5, FORMULA5, POLICY_NUMBER5, CURRENCY5, EXCESS5, DURATION5, TOTAL_AMOUNT_INSURED5,";
		sqlstmt = sqlstmt+" CIE_HT_BASIS5, COMPANY6,FORMULE_NAME6, FORMULA6, POLICY_NUMBER6, CURRENCY6, EXCESS6, DURATION6, TOTAL_AMOUNT_INSURED6, CIE_HT_BASIS6, COMPANY7,FORMULE_NAME7, FORMULA7, POLICY_NUMBER7,";
		sqlstmt = sqlstmt+" CURRENCY7, EXCESS67, DURATION7, TOTAL_AMOUNT_INSURED7, CIE_HT_BASIS7, COMPANY8,FORMULE_NAME8, FORMULA8, POLICY_NUMBER8, CURRENCY8, EXCESS8, DURATION8, TOTAL_AMOUNT_INSURED8,";
		...
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(MONTHLY_SALARY,',','.')!='' then REPLACE(MONTHLY_SALARY,',','.') else  '0' end  as Integer),";
		sqlstmt = sqlstmt+" SALARY_CURRENCY,PERIOD_INSURANCE ,cast(DAYS as Integer),cast(MONTHS as Integer),FAMILY_COVERED,RETIREMENT_PLAN,";
		...
		sqlstmt = sqlstmt+" EMPLOYER,CHILDREN,COUNTRY,NATIONALITY,COMPANY1,FORMULE_NAME1,FORMULA1,POLICY_NUMBER1,CURRENCY1,EXCESS1,DURATION1,";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(TOTAL_AMOUNT_INSURED1,',','.')!='' then REPLACE(TOTAL_AMOUNT_INSURED1,',','.')  else  '0' end  as Float) ,";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(REPLACE(CIE_HT_BASIS1,'%','') ,',','.') !=''  then REPLACE(REPLACE(CIE_HT_BASIS1,'%','') ,',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" COMPANY2,FORMULE_NAME2,FORMULA2,POLICY_NUMBER2,CURRENCY2,EXCESS2,DURATION2,";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(TOTAL_AMOUNT_INSURED2,',','.')!=''  then REPLACE(TOTAL_AMOUNT_INSURED2,',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(REPLACE(CIE_HT_BASIS2,'%',''),',','.') !='' then REPLACE(REPLACE(CIE_HT_BASIS2,'%',''),',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" COMPANY3,FORMULE_NAME3,FORMULA3,POLICY_NUMBER3,CURRENCY3,EXCESS3,DURATION3,";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(TOTAL_AMOUNT_INSURED3,',','.')!='' then REPLACE(TOTAL_AMOUNT_INSURED3,',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(REPLACE(CIE_HT_BASIS3,'%',''),',','.') !='' then REPLACE(REPLACE(CIE_HT_BASIS3,'%',''),',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" COMPANY4,FORMULE_NAME4,FORMULA4,POLICY_NUMBER4,CURRENCY4,EXCESS4,DURATION4,";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(TOTAL_AMOUNT_INSURED4,',','.') !='' then REPLACE(TOTAL_AMOUNT_INSURED4,',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(REPLACE(CIE_HT_BASIS4,'%',''),',','.') !='' then REPLACE(REPLACE(CIE_HT_BASIS4,'%',''),',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" COMPANY5,FORMULE_NAME5, FORMULA5, POLICY_NUMBER5, CURRENCY5, EXCESS5, DURATION5,";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(TOTAL_AMOUNT_INSURED5,',','.') !='' then REPLACE(TOTAL_AMOUNT_INSURED5,',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(REPLACE(CIE_HT_BASIS5,'%',''),',','.') !='' then REPLACE(REPLACE(CIE_HT_BASIS5,'%',''),',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" COMPANY6,FORMULE_NAME6, FORMULA, POLICY_NUMBER6, CURRENCY6, EXCESS6, DURATION6,";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(TOTAL_AMOUNT_INSURED6,',','.') !='' then REPLACE(TOTAL_AMOUNT_INSURED6,',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(REPLACE(CIE_HT_BASIS6,'%',''),',','.') !='' then REPLACE(REPLACE(CIE_HT_BASIS6,'%',''),',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" COMPANY7, FORMULE_NAME7,FORMULA7, POLICY_NUMBER7, CURRENCY7, EXCESS67, DURATION7,";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(TOTAL_AMOUNT_INSURED7,',','.')  !='' then REPLACE(TOTAL_AMOUNT_INSURED7,',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(REPLACE(CIE_HT_BASIS7,'%',''),',','.') !='' then REPLACE(REPLACE(CIE_HT_BASIS7,'%',''),',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" COMPANY8,FORMULE_NAME8, FORMULA8, POLICY_NUMBER8, CURRENCY8, EXCESS8, DURATION8,";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(TOTAL_AMOUNT_INSURED8,',','.') !='' then REPLACE(TOTAL_AMOUNT_INSURED8,',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" CAST( CASE WHEN REPLACE(REPLACE(CIE_HT_BASIS8,'%',''),',','.') !='' then REPLACE(REPLACE(CIE_HT_BASIS8,'%',''),',','.') else  '0' end  as Float),";
		sqlstmt = sqlstmt+" ( SELECT COUNT(*) FROM mvt yt2 WHERE yt2.wycc_id = yt1.wycc_id ), ";
		sqlstmt = sqlstmt+" ( SELECT COUNT(*) FROM mvt yt2 WHERE yt2.wycc_id = yt1.wycc_id AND TO_TIMESTAMP(yt2.start_movement,'dd/MM/yyyy') < DATEADD( 'DAY', 1,  TO_TIMESTAMP(yt1.end_movement,'dd/MM/yyyy') ) ),";
		sqlstmt = sqlstmt+" ( SELECT COUNT(*) FROM mvt yt2 WHERE yt2.wycc_id = yt1.wycc_id AND TO_TIMESTAMP(yt2.end_movement,'dd/MM/yyyy') = DATEADD( 'DAY', -1, TO_TIMESTAMP(yt1.start_movement,'dd/MM/yyyy') ) ), ";
		sqlstmt = sqlstmt+" ( SELECT MIN( TO_TIMESTAMP( yt2.start_movement, 'dd/MM/yyyy' ) ) FROM mvt yt2 WHERE yt2.wycc_id = yt1.wycc_id AND TO_TIMESTAMP(yt2.start_movement,'dd/MM/yyyy') > TO_TIMESTAMP(yt1.end_movement,'dd/MM/yyyy') ),";
		sqlstmt = sqlstmt+" ( SELECT Max( TO_TIMESTAMP( yt2.end_movement, 'dd/MM/yyyy' )) FROM mvt yt2 WHERE yt2.wycc_id = yt1.wycc_id AND TO_TIMESTAMP( yt2.end_movement, 'dd/MM/yyyy' ) < TO_TIMESTAMP( yt1.start_movement, 'dd/MM/yyyy' ) ) dateprev";
	...
	public String insertbeneficiairies ()
	{
		...
		sqlstmt = sqlstmt+ " COUNTRY, POSITIONCREW, PERIOD_INSURANCE, START_MOVEMENT, PREVMVT, ENDCOMP, END_MOVEMENT, ";
		sqlstmt = sqlstmt+ "NEXTMVT, NEXTCOMP, MONTHLY_SALARY, SALARY_CURRENCY, DRESTEJ, ERESTEJ, JOUR,MOIS, TO_INVOICE,";
		sqlstmt = sqlstmt+ " company1,formule1,formule_name1, total_amount_insured1,company2,formule2, formule_name2, total_amount_insured2,company3,formule3, formule_name3, total_amount_insured3,";
		sqlstmt = sqlstmt+ " company4,formule4,formule_name4, total_amount_insured4,company5,formule5, formule_name5, total_amount_insured5,company6,formule6, formule_name6, total_amount_insured6,";
	    sqlstmt = sqlstmt+ " company7,formule7,formule_name7,total_amount_insured7,company8,formule8,formule_name8,total_amount_insured8)";
		...
		sqlstmt = sqlstmt+"        AND (DATEDIFF('DAY', START_MOVEMENT, DATEADD('DAY', 1, PREVMVT)) = 0)) THEN ROUND(((30.0 - (1.0*DRESTEJ)) / 30.0), 5) ELSE 0 END) + CASE WHEN ((LINE <> 1)";
		sqlstmt = sqlstmt+"        AND (DATEDIFF('DAY', END_MOVEMENT, DATEADD('DAY', -1, NEXTMVT)) = 0)) THEN ROUND(((1.0*ERESTEJ) / 30.0), 5) ELSE 0 END) AS TO_INVOICE,";
		sqlstmt = sqlstmt+ " company1,formule1,formule_name1, total_amount_insured1,company2,formule2, formule_name2, total_amount_insured2,company3,formule3, formule_name3, total_amount_insured3,";
		sqlstmt = sqlstmt+ " company4,formule4,formule_name4, total_amount_insured4,company5,formule5, formule_name5, total_amount_insured5,company6,formule6, formule_name6, total_amount_insured6,";
	    sqlstmt = sqlstmt+ " company7,formule7,formule_name7,total_amount_insured7,company8,formule8,formule_name8,total_amount_insured8";
	...
	public String insertListMvt(){
		...
		sqlstmt = sqlstmt+" MONTHLY_SALARY,";
		sqlstmt = sqlstmt+" SALARY_CURRENCY";
		sqlstmt = sqlstmt+" FROM (WITH RECURSIVE LIST(POSITIONCREW,NAME,FIRST_NAME,STRUCTURE_NAME,CREWMANNING,PERIOD,FAMILY_COVERED,NATIONALITY,COUNTRY,CHILDREN,MONTHLY_SALARY,SALARY_CURRENCY,RANG,LINE,WYCC_ID,START_MOVEMENT,END_MOVEMENT,DATEOFNEXTMVT,DATEOFPREVMVT,RANKMVT,RANKPARENT) AS (";
		sqlstmt = sqlstmt+" (SELECTPOSITIONCREW,NAME,FIRST_NAME,STRUCTURE_NAME,NULL AS CREWMANNING,PERIOD,FAMILY_COVERED,NATIONALITY,COUNTRY,CHILDREN,MONTHLY_SALARY,SALARY_CURRENCY,MVT_NUM_ID,RANKMVT,WYCC_ID,";
		sqlstmt = sqlstmt+"CASE WHEN (START_MOVEMENT < TIMESTAMP '2016-01-01 00:00:00.0') THEN TIMESTAMP '2016-01-01 00:00:00.0' ELSE START_MOVEMENT END AS START_MOVEMENT,";
		sqlstmt = sqlstmt+"CASE WHEN (END_MOVEMENT > TIMESTAMP '2016-12-31 00:00:00.0') THEN TIMESTAMP '2016-12-31 00:00:00.0' ELSE END_MOVEMENT END AS END_MOVEMENT,";
		...
		sqlstmt = sqlstmt+"'NULL AS CREWMANNING, M.PERIOD, M.FAMILY_COVERED, M.NATIONALITY,M.COUNTRY, M.CHILDREN,M.MONTHLY_SALARY,M.SALARY_CURRENCY, L.RANG, M.RANKMVT, M.WYCC_ID,";
		sqlstmt = sqlstmt+"CASE WHEN (M.START_MOVEMENT < TIMESTAMP '2016-01-01 00:00:00.0') THEN TIMESTAMP '2016-01-01 00:00:00.0' ELSE M.START_MOVEMENT END AS START_MOVEMENT,";
		sqlstmt = sqlstmt+"CASE WHEN (M.END_MOVEMENT > TIMESTAMP '2016-12-31 00:00:00.0') THEN TIMESTAMP '2016-12-31 00:00:00.0' ELSE M.END_MOVEMENT END AS END_MOVEMENT,";
		sqlstmt = sqlstmt+" M.DATEOFNEXTMVT,  M.DATEOFPREVMVT,  M.RANKMVT, M.RANKPARENT";
		sqlstmt = sqlstmt+" FROM PUBLIC.MVT_NUM M INNER JOIN PUBLIC.LIST L ON 1=1 WHERE (NEXTMVT <> 0) AND ((M.WYCC_ID = L.WYCC_ID) AND (M.START_MOVEMENT = L.DATEOFNEXTMVT))) )";
		sqlstmt = sqlstmt+"SELECT";
		sqlstmt = sqlstmt+"         WYCC_ID,";
		sqlstmt = sqlstmt+"         RANG,";
		...
		sqlstmt = sqlstmt+"     FROM LIST GROUP BY WYCC_ID, RANG, POSITIONCREW, NAME, FIRST_NAME, STRUCTURE_NAME, CREWMANNING, PERIOD, FAMILY_COVERED, NATIONALITY, COUNTRY, CHILDREN, SALARY_CURRENCY";
	...
	public String insertRootListMvthier (){
		...
		sqlstmt = sqlstmt+" company1,formule1,formule_name1,POLICE_NUMBER1, total_amount_insured1,company2,formule2, formule_name2,POLICE_NUMBER2, total_amount_insured2,company3,formule3, formule_name3,POLICE_NUMBER3, total_amount_insured3,";
		sqlstmt = sqlstmt+" company4,formule4,formule_name4,POLICE_NUMBER4, total_amount_insured4,company5,formule5, formule_name5,POLICE_NUMBER5, total_amount_insured5,company6,formule6, formule_name6,POLICE_NUMBER6, total_amount_insured6,";
		sqlstmt = sqlstmt+" company7,formule7,formule_name7,POLICE_NUMBER7, total_amount_insured7,company8,formule8, formule_name8,POLICE_NUMBER8,total_amount_insured8,";
		sqlstmt = sqlstmt+" crewmanning, period_insurance, family_covered,";
		sqlstmt = sqlstmt+" nationality, country, children, monthly_salary, salary_currency,  niveau, wycc_id, start_movement, end_movement,";
		...
		sqlstmt = sqlstmt+" company1,formula1,formule_name1,POLICY_NUMBER1, total_amount_insured1,company2,formula2, formule_name2,POLICY_NUMBER2, total_amount_insured2,company3,formula3, formule_name3,POLICY_NUMBER3, total_amount_insured3,";
		sqlstmt = sqlstmt+" company4,formula4,formule_name4,POLICY_NUMBER4, total_amount_insured4,company5,formula5, formule_name5,POLICY_NUMBER5, total_amount_insured5,company6,formula6, formule_name6,POLICY_NUMBER6, total_amount_insured6,";
		sqlstmt = sqlstmt+" company7,formula7,formule_name7,POLICY_NUMBER7, total_amount_insured7,company8,formula8, formule_name8,POLICY_NUMBER8,total_amount_insured8,";
		sqlstmt = sqlstmt+"					 '' as crewmanning,  m.period_insurance,  m.family_covered,  m.nationality,  m.country,";
		sqlstmt = sqlstmt+"					  m.children,  m.monthly_salary,  m.salary_currency,   m.rankmvt as niveau,";
		sqlstmt = sqlstmt+"					  m.wycc_id,";
		sqlstmt = sqlstmt+"					 case when ( m.start_movement < timestamp '2016-01-01 00:00:00.0') then timestamp '2016-01-01 00:00:00.0' else  m.start_movement end as start_movement,";
		sqlstmt = sqlstmt+"					 case when ( m.end_movement > timestamp '2016-12-31 00:00:00.0') then timestamp '2016-12-31 00:00:00.0' else  m.end_movement end as end_movement,";
		sqlstmt = sqlstmt+"					  m.dateofnextmvt,  m.dateofprevmvt,  m.rankmvt,  m.rankparent,  m.nextmvt";
	...
	public String insertLevelNListMvthier (){
		...
		sqlstmt = sqlstmt+"  m.company1,m.formula1,m.formule_name1,m.POLICY_NUMBER1, m.total_amount_insured1, m.company2,m.formula2, m.formule_name2,m.POLICY_NUMBER2, m.total_amount_insured2, m.company3,m.formula3, m.formule_name3,m.POLICY_NUMBER3, m.total_amount_insured3,";
		sqlstmt = sqlstmt+"  m.company4,m.formula4,m.formule_name4,m.POLICY_NUMBER4, m.total_amount_insured4, m.company5,m.formula5, m.formule_name5,m.POLICY_NUMBER5, m.total_amount_insured5, m.company6,m.formula6, m.formule_name6,m.POLICY_NUMBER6, m.total_amount_insured6,";
		sqlstmt = sqlstmt+"  m.company7,m.formula7,m.formule_name7,m.POLICY_NUMBER7, m.total_amount_insured7, m.company8,m.formula8, m.formule_name8,m.POLICY_NUMBER8, m.total_amount_insured8,";
		sqlstmt = sqlstmt+"					 '' as crewmanning,  m.period_insurance,  m.family_covered,  m.nationality,  m.country,";
		sqlstmt = sqlstmt+"					  m.children,  m.monthly_salary,  m.salary_currency,   m.rankmvt as niveau,";
		sqlstmt = sqlstmt+"					  m.wycc_id,";
		sqlstmt = sqlstmt+"					 case when ( m.start_movement < timestamp '2016-01-01 00:00:00.0') then timestamp '2016-01-01 00:00:00.0' else  m.start_movement end as start_movement,";
